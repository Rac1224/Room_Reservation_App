...
namespace IOOP_ASSIGNMENT {
    ...
    public partial class ReservationSystemDataSet : global::System.Data.DataSet {
        ...
        public partial class reservationDataTable : global::System.Data.TypedTableBase<reservationRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public reservationRow AddreservationRow(string roomName, System.DateTime date, System.TimeSpan startTime, System.TimeSpan endTime, string studentID, string studentName) {
...
namespace IOOP_ASSIGNMENT.ReservationSystemDataSetTableAdapters {
    ...
    public partial class reservationTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[reservation] WHERE (([reservationID] = @Original_reservationID) AND ([roomName] = @Original_roomName) AND ([date] = @Original_date) AND ([startTime] = @Original_startTime) AND ([endTime] = @Original_endTime) AND ([studentID] = @Original_studentID) AND ([studentName] = @Original_studentName))";
...
SELECT reservationID, roomName, date, startTime, endTime, studentID, studentName FROM reservation WHERE (reservationID = @reservationID)";
        ...
        public virtual int Delete(int Original_reservationID, string Original_roomName, System.DateTime Original_date, System.TimeSpan Original_startTime, System.TimeSpan Original_endTime, string Original_studentID, string Original_studentName) {
        ...
        public virtual int Update(string roomName, System.DateTime date, System.TimeSpan startTime, System.TimeSpan endTime, string studentID, string studentName, int Original_reservationID, string Original_roomName, System.DateTime Original_date, System.TimeSpan Original_startTime, System.TimeSpan Original_endTime, string Original_studentID, string Original_studentName, int reservationID) {
            if ((roomName == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[9].Value = ((System.TimeSpan)(Original_startTime));
            this.Adapter.UpdateCommand.Parameters[10].Value = ((System.TimeSpan)(Original_endTime));
            if ((Original_studentID == null)) {
                throw new global::System.ArgumentNullException("Original_studentID");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string roomName, System.DateTime date, System.TimeSpan startTime, System.TimeSpan endTime, string studentID, string studentName, int Original_reservationID, string Original_roomName, System.DateTime Original_date, System.TimeSpan Original_startTime, System.TimeSpan Original_endTime, string Original_studentID, string Original_studentName) {
            return this.Update(roomName, date, startTime, endTime, studentID, studentName, Original_reservationID, Original_roomName, Original_date, Original_startTime, Original_endTime, Original_studentID, Original_studentName, Original_reservationID);
        }
    }
